 ...
 */
public class CameraToH264 extends AndroidTestCase {
    private static final String TAG = "CameraToH264";
    ...
    private static class CameraToMpegWrapper implements Runnable {
        ...
        private CameraToH264 mTest;

        private CameraToMpegWrapper(CameraToH264 test) {
            mTest = test;
        }
         ...
         * Entry point.
         */
        public static void runTest(CameraToH264 obj) throws Throwable {
    ...
    private static class SurfaceTextureManager
        ...
        private CameraToH264.STextureRender mTextureRender;
        ...
        public SurfaceTextureManager() {
            mTextureRender = new CameraToH264.STextureRender();
